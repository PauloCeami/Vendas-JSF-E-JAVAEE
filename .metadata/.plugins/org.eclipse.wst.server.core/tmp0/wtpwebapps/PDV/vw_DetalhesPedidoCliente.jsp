            ...
            <div class="row">         
                <form action="." method="post">  
                    ...
                    <fieldset class="fieldsetVendas">
                        <legend>Visualização do Pedido <%=null != ped ? ped.getID() : ""%> <a class="btn btn-mini btn-danger" href="./?acao=RemovePedido&idPedido=<%=ped.getID() %>&clienteID=<%=ped.getCLIENTEID() %>&nome=<%=cli.getNome()%>">Excluir Pedido </a> </legend>

                        <div class="formulario">
                            <label class="labelFormulario">Pedido Número.... <%=ped.getID()%></label>
